...
const builder = {
    ...
    debug: (pkg, src, tag, msg) => {
        ...
        builder.importScripts(["./dist/libs/attachWindowCursorEvent.js", "./dist/libs/initInterface.js", "./dist/libs/exportDrawable.js", "./dist/libs/drawMap.js", "./dist/libs/selectLineDialog.js", "./dist/libs/initDrawable.js", "./dist/libs/SystemFunction.js", "./dist/libs/editPathsInfo.js", "./dist/libs/savePathComp.js", "./dist/libs/colorUtils.js", "./assets/Colors/Colors.js", "./assets/locales/" + builder.locales[pg.language] + ".js"], returnFunc);
